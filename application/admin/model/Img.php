...
class Img extends Model
{
    ...
    {
        Img::event('before_insert',function($down){
            if(isset($_FILES['softpic'])){
                ...
                if(self::getExt(basename(request()->post('thumbImg')))!=='gif'){
                    Image::ImgWater(request()->post('thumbImg'),'./watermark.gif');
                }
                //ftp上传
...
//              外链图片
        ...
        Img::event('before_update',function($down){
//      	    修改缩略图片
...
//              外链图片
        ...
        Img::event('before_delete',function($down){
